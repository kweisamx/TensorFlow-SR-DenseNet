...
flags.DEFINE_integer("label_size", 34, "The size of label")
...
flags.DEFINE_float("learning_rate", 1e-1, "The learning rate")
flags.DEFINE_integer("batch_size", 1, "the size of batch")
flags.DEFINE_integer("des_block_H", 1, "the size dense_block layer number")
flags.DEFINE_integer("des_block_ALL", 1, "the size dense_block")
